 ...
 * @Project Batch-Excel
 * @Package org.rizki.mufrizal.batch.excel.jobs
 * @File MessageStreamWriter
 */
@Slf4j
@Component
public class MessageStreamWriter implements ItemStreamWriter<Agent> {
    ...
    public void write(List<? extends Agent> list) throws Exception {
        list.forEach(l -> {
            log.info("Writer One : {}", l.getKodeAgent() + " - " + l.getNamaAgent() + " - " + l.getAlamat1() + " " + l.getAlamat2());
        });
    }
}
